...
def check_blockdev(
    ...
    with HealthCheckRuntime(
        ...
        health_check_name=HealthCheckName.CHECK_BLOCKDEV,
        killswitch_getter=lambda: FeatureValueHealthChecksFeatures().get_healthchecksfeatures_disable_check_blockdev(),
    ) as rt:
